...
const pathData = computed(() => {
  const sourcePos = props.sourceHandleId?.replace('source-', '').replace('target-', '') && HANDLE_MAP[props.sourcePosition] ? HANDLE_MAP[props.sourcePosition] : props.sourcePosition
  const targetPos = props.targetHandle?.replace('source-', '').replace('target-', '') && HANDLE_MAP[props.targetPosition] ? HANDLE_MAP[props.targetPosition] : props.targetPosition
